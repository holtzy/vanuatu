...
# Prepare damage data for mapping
# Note: "Tanvasoko" (Shefa) not found in 2016 GeoJSON boundaries
...
leaflet(councils_map) %>%
  ...
  addPolygons(
    ...
    label = ~paste0(
      ...
      "Households Damaged: ", format(round(private_households_damaged, 0), big.mark = ",")
