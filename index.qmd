...
damage_estimates <- education_with_config %>%
  ...
  mutate(
    # ECCE
    ecce_schools_damaged = round(ecce_schools * get_damage_multiplier(Intensity, "ecce", "schools")),
    ecce_students_affected = round(ecce_students * get_damage_multiplier(Intensity, "ecce", "students")),
    
    # Primary
    primary_schools_damaged = round(primary_schools * get_damage_multiplier(Intensity, "primary", "schools")),
    primary_students_affected = round(primary_students * get_damage_multiplier(Intensity, "primary", "students")),
    
    # Secondary
    secondary_schools_damaged = round(secondary_schools * get_damage_multiplier(Intensity, "secondary", "schools")),
    secondary_students_affected = round(secondary_students * get_damage_multiplier(Intensity, "secondary", "students"))
  ) %>%
  ungroup() %>%
