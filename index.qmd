...
write.csv(
  ...
  here::here("output", "01_baseline_education.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  here::here("output", "02_damage_estimates.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  here::here("output", "03_resources_needed.csv"),
  row.names = FALSE
)
...
# === EXPORT TO CSV ===
write.csv(
  financial_damage_full,
  here::here("output", "04_financial_damage.csv"),
  row.names = FALSE
)
