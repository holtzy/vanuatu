...
reactable(
  ...
  columnGroups = list(
    colGroup(name = "Region", columns = c("Region")),
    colGroup(name = "Total Households", columns = c("total_households")),
    colGroup(name = "Drinking Water", columns = c("water_piped", "water_well", "water_tank")),
    colGroup(name = "Toilet Type", columns = c("toilet_pit latrine", "toilet_vip", "toilet_flush", "toilet_water sealed"))
  ),
  striped = TRUE,
  highlight = TRUE,
  bordered = TRUE,
...
wash_damage_ordered <- wash_damage_aggregated %>%
  select(Region, water_piped_damaged, water_well_damaged, water_tank_damaged,
         toilet_pit_latrine_damaged, toilet_vip_damaged, toilet_flush_damaged, toilet_water_sealed_damaged)
...
reactable(
  ...
  columnGroups = list(
    colGroup(name = "Region", columns = c("Region")),
    colGroup(name = "Drinking Water", columns = c("water_piped_damaged", "water_well_damaged", "water_tank_damaged")),
    colGroup(name = "Toilet Type", columns = c("toilet_pit_latrine_damaged", "toilet_vip_damaged", "toilet_flush_damaged", "toilet_water_sealed_damaged"))
  ),
  striped = TRUE,
  highlight = TRUE,
  bordered = TRUE,
...
write.csv(
  ...
  here::here("output", "Business_01_baseline_industry_types.csv"),
  row.names = FALSE
)
