...
education_with_config <- education_wide %>%
  ...
  # Extract the cyclone category number from Intensity (e.g., "Category 5" -> "5")
  mutate(category = as.character(gsub("Category ", "", Intensity)))
...
get_damage_multiplier <- function(cyclone_category, education_level, measure_type) {
  multiplier <- baseline_factors %>%
    ...
    pull(!!paste0("Intensity ", cyclone_category))
