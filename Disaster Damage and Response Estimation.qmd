...
default_cyclone_category <- 3  # Default cyclone category (can be customized)
...
calculate_resources <- function(region_data, cyclone_category, days = 14) {
  ...
  region_data %>%
    mutate(
      ...
      # ECCE Resources
      ECCE_Tents = round(ECCE_Schools * damage_multiplier * get_resource_multiplier("Tent"), 1),
      ECCE_Solar_Lamps = round(ECCE_Schools * damage_multiplier * get_resource_multiplier("Solar Lamp"), 0),
      ECCE_Water = round(ECCE_Students * damage_multiplier * get_resource_multiplier("Water") * days, 1),
      ...
      # Primary Resources  
      Primary_Tents = round(Primary_Schools * damage_multiplier * get_resource_multiplier("Tent"), 1),
      Primary_Solar_Lamps = round(Primary_Schools * damage_multiplier * get_resource_multiplier("Solar Lamp"), 0),
      Primary_Water = round(Primary_Students * damage_multiplier * get_resource_multiplier("Water") * days, 1),
      ...
      # Secondary Resources
      Secondary_Tents = round(Secondary_Schools * damage_multiplier * get_resource_multiplier("Tent"), 1),
      Secondary_Solar_Lamps = round(Secondary_Schools * damage_multiplier * get_resource_multiplier("Solar Lamp"), 0),
      Secondary_Water = round(Secondary_Students * damage_multiplier * get_resource_multiplier("Water") * days, 1),
...
reactable(
  ...
  columns = list(
    ...
    # Secondary columns
    Secondary_Tents = colDef(name = "Tents", format = colFormat(digits = 1)),
    Secondary_Solar_Lamps = colDef(name = "Solar Lamps", format = colFormat(digits = 0)),
    Secondary_Water = colDef(name = "Water (L)", format = colFormat(digits = 1)),
